...
The plugin uses the [Cloud Foundry loggregator API](https://github.com/cloudfoundry/go-loggregator) to get the data and the gocui to present it on a terminal.  
